...
import sys, os, math, ConfigParser, shlex, subprocess
...
# Mean molecular weight of all gas = molecular hydrogen [g/mol]
MMW = 2.02
...
PTfile = directory+'pressureTemperature.dat'
...
command = 'python '+scriptDir+'/plotOpacity.py ' + atmosphere
