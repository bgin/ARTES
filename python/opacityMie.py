...
atmosphere = 'clouds'
fitsfile = 'ammonia.fits'
riFile = 'ammonia_ice.dat'
...
amin = 0.1 # Minimum particle size [micron]
amax = 5.0 # Maximum particle size [micron]
...
r_eff = 1.4 # Effective radius [micron], overrules amin, amax, apow
v_eff = 0.05 # Effective variance [micron], overrules amin, amax, apow
...
riDir = scriptDir[:-6]+'dat/refractive_index/'
